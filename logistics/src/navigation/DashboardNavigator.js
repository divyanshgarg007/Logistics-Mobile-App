...
import { BookingDetailsView, ChangePasswordView, CustomerDashboardView, MyProfileView } from '../screens';
...
export function DashboardNavigator(props) {
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        name={NAVIGATION.customerDashboard}
      ...
      <Stack.Screen
        ...
        options={({ navigation }) => ({
          ...
          headerTitle: () => {
            return (
              <Text style={styles.navigatorText}>Booking Details</Text>
            );
          },
        })}
      />
